//  @@@ web_tree_date_search_extension custom JS @@@
// #############################################################################
//
...
openerp.web_tree_date_search_extension = function(instance) {
    ...
    // Replace the path
    instance.web.views.map['list'] = 'instance.web_tree_date_search_extension.ListView';

    instance.web_tree_date_search_extension.ListView = instance.web.ListView.extend({
